...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Saviour Core saviour-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  saviour-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded saviour transaction") + "\n" +
                               "  saviour-tx [options] -create [commands]   " + _("Create hex-encoded saviour transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded saviour transaction
