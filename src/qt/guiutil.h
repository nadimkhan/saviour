...
/** Utility functions used by the SAVIOUR Qt UI.
 */
namespace GUIUtil
{
...
// Render SAVIOUR addresses in monospace font
...
// Parse "saviour:" URI into recipient object, return true on successful parsing
