                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Saviour Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a SAVIOUR address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and saviour: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Saviour Core"), this);
    aboutAction->setStatusTip(tr("Show information about Saviour Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for SAVIOUR"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your SAVIOUR addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified SAVIOUR addresses"));
    ...
    openAction->setStatusTip(tr("Open a SAVIOUR: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Saviour Core help message to get a list with possible SAVIOUR command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Saviour Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to SAVIOUR network", "", count));
}
...
{
    QString strTitle = tr("Saviour Core"); // default title
