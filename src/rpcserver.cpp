...
Value stop(const Array& params, bool fHelp)
{
    ...
    StartShutdown();
    return "SAVIOUR server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Saviour features */
        {"saviour", "masternode", &masternode, true, true, false},
        {"saviour", "listmasternodes", &listmasternodes, true, true, false},
        {"saviour", "getmasternodecount", &getmasternodecount, true, true, false},
        {"saviour", "masternodeconnect", &masternodeconnect, true, true, false},
        {"saviour", "masternodecurrent", &masternodecurrent, true, true, false},
        {"saviour", "masternodedebug", &masternodedebug, true, true, false},
        {"saviour", "startmasternode", &startmasternode, true, true, false},
        {"saviour", "createmasternodekey", &createmasternodekey, true, true, false},
        {"saviour", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"saviour", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"saviour", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"saviour", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"saviour", "getmasternodescores", &getmasternodescores, true, true, false},
        {"saviour", "mnbudget", &mnbudget, true, true, false},
        {"saviour", "preparebudget", &preparebudget, true, true, false},
        {"saviour", "submitbudget", &submitbudget, true, true, false},
        {"saviour", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"saviour", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"saviour", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"saviour", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"saviour", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"saviour", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"saviour", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"saviour", "checkbudgets", &checkbudgets, true, true, false},
        {"saviour", "mnsync", &mnsync, true, true, false},
        {"saviour", "spork", &spork, true, true, false},
        {"saviour", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"saviour", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use saviourd, or the -server option to saviour-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> saviour-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:22101/\n";
}
