...
In order to support loading of multiple wallets in saviour-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is saviour.cpp.
...
Changes to saviour.cpp
----------------------
saviour.cpp is the entry point into saviour-qt, and as such, will require some minor modifications to provide hooks for
