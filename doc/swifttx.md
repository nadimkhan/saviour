...
This mechanism has been integrated into Bitcore-Node-SAVIOUR which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/nadimkhan/insight-api-saviour#web-socket-api](https://github.com/nadimkhan/insight-api-saviour#web-socket-api) 
* API: [https://github.com/nadimkhan/insight-api-saviour#swifttx-transactions](https://github.com/nadimkhan/insight-api-saviour#swifttx-transactions) 
...
By default, the Saviour Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Saviour Core daemon:
