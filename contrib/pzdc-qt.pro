...
RESOURCES += src/qt/saviour.qrc src/qt/saviour_locale.qrc

TRANSLATIONS += src/qt/locale/saviour_bg.ts \
                src/qt/locale/saviour_de.ts \
                src/qt/locale/saviour_en.ts \
                src/qt/locale/saviour_es.ts \
                src/qt/locale/saviour_fi.ts \
                src/qt/locale/saviour_fr.ts \
                src/qt/locale/saviour_it.ts \
                src/qt/locale/saviour_ja.ts \
                src/qt/locale/saviour_pl.ts \
                src/qt/locale/saviour_pt.ts \
                src/qt/locale/saviour_ru.ts \
                src/qt/locale/saviour_sk.ts \
                src/qt/locale/saviour_sv.ts \
                src/qt/locale/saviour_vi.ts \
                src/qt/locale/saviour_zh_CN.ts \
                src/qt/locale/saviour_zh_TW.ts
