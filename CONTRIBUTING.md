Contributing to Saviour Core
============================

The Saviour Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Saviour Core project, and is not to be
confused with overall SAVIOUR Network Protocol consensus changes.

Whether a pull request is merged into Saviour Core rests with the project merge
...
Patches that change SAVIOUR consensus rules are considerably more involved than
...
Where a patch set proposes to change the SAVIOUR consensus, it must have been
...
The project leader is the release manager for each Saviour Core release.
